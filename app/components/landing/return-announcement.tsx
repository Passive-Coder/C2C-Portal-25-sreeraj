...
const SECTORS: Sector[] = [
	...
	{ key: "cutout", centerDeg: 180, color: "rgba(44, 44, 44, 0.84)", delay: "610ms", eyebrow: "Coming", value: "September 4th-6th 2026" },
		...
		<div className={`c2c-upcoming ${active ? "is-active" : ""}`}>
			...
			>
				...
				<span className="c2c-upcoming-button__content">
					{active ? "Back to site" : "Explore the Latest Edition"}
				</span>
			</button>
		</div>
	);
